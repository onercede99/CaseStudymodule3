...
<head>
    ...
    <%-- Bootstrap Icons (nếu bạn dùng class bi-search) --%>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">
    <%-- Link đến file CSS chung của bạn --%>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link ${pageContext.request.servletPath == '/rooms' ? 'active' : ''}" href="${pageContext.request.contextPath}/rooms"><i class="fas fa-door-open"></i> Phòng</a>
                </li>
                <li class="nav-item">
                ...
                <c:choose>
                    <c:when test="${not empty sessionScope.adminUser}"> <%-- Sửa key session thành adminUser --%>
                    ...
                    <c:otherwise>
                        ...
                        <%-- Có thể thêm link đăng nhập/đăng ký cho user thường nếu có --%>
                        <%--
                        <li class="nav-item">
...
<%-- Thanh tìm kiếm có điều kiện hiển thị --%>
<c:if test='${pageContext.request.servletPath == "/rooms" || pageContext.request.servletPath == "/index.jsp" || pageContext.request.servletPath == "/"}'>
...
<%-- Phần header.jsp kết thúc ở đây, nội dung chính của trang sẽ được chèn sau khi include header này --%>